      ...
      <div className="max-w-4xl mx-auto px-4 py-6 space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="space-y-6">
            ...
            {/* Reputation (if service provider) */}
            {contact.is_service_provider && contact.reputation_score && (
              <div className="bg-gray-800 rounded-2xl p-5">
                <h2 className="text-lg font-semibold text-white mb-3 flex items-center gap-2">
                ...
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-xs">{contact.review_count} reviews</p>
                  </div>
                </div>
                {contact.reputation_summary && (
                  <p className="text-gray-300 text-sm">{contact.reputation_summary}</p>
                )}
              </div>
            )}
